...
CONSUMPTION_OUTPUT_HEADER_TRANSLATIONS = {
    ...
    "c_shrub_1live": ["shrub", "primary live", "total"],
    "c_shrub_1dead": ["shrub", "primary dead", "total"],
    "c_shrub_2live": ["shrub", "secondary live", "total"],
    "c_shrub_2dead": ["shrub", "secondary dead", "total"],
    "c_herb_1live": ["nonwoody", "primary live", "total"],
    "c_herb_1dead": ["nonwoody", "primary dead", "total"],
    "c_herb_2live": ["nonwoody", "secondary live", "total"],
    "c_herb_2dead": ["nonwoody", "secondary dead", "total"],
        ...
        for k in r:
            if k in CONSUMPTION_OUTPUT_HEADER_TRANSLATIONS:
                ...
                if args.emissions_model == "consume":
                    ...
                    fb_e[p][s][0] = numpy.round(fb_e[p][s][0] * TONS_PER_POUND, 2)
                ...
                if args.emissions_model == "consume":
                    ...
                    fb_ed[a][b][c][d][0] = numpy.round(
                        fb_ed[a][b][c][d][0] * TONS_PER_POUND, 2)
