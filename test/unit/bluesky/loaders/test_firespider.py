...
FSV3_INPUT_FILENAME = os.path.join(data_dir, 'fires-spider-v3-input.json')
FSV3_LOADED_FILENAME = os.path.join(data_dir, 'fires-spider-v3-loaded.json')
