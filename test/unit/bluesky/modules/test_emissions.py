...
class TestPrichardOneillEmissions(BaseEmissionsTest):
    ...
    EXPECTED_FIRE1_EMISSIONS = {
        ...
        'smoldering': {
            'CH4': [6.102610440157499],
            'CO': [126.18844357545001],
            'CO2': [1414.5861883575],
            'NH3': [1.6569200000000002],
            'NOx': [0.9725400000000001],
            'PM10': [18.667365000000004],
            'PM2.5': [13.33045667521],
            'SO2': [1.5593568286335]
        },
        'total': {
            'CH4': [7.1065467482328994],
            'CO': [150.83942726688397],
            'CO2': [1913.6715864883001],
            'NH3': [1.9841380000000002],
            'NOx': [1.4858820000000001],
            'PM10': [24.890511000000004],
            'PM2.5': [17.146874277555998],
            'SO2': [1.9545791958743002]
        }
    }
