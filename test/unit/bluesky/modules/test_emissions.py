...
class TestPrichardOneillEmissions(BaseEmissionsTest):
    ...
    EXPECTED_FIRE1_EMISSIONS = {
        'flaming': {
            'CH4': [1.023682],
            'CO': [24.006994],
            'CO2': [499.20858400000003],
            'NH3': [0.249166],
            'NOx': [0.44729800000000003],
            'PM10': [6.223146000000001],
            'PM2.5': [4.0527],
            'SO2': [0.40526999999999996]
        },
        'residual': {
            'CH4': [0.0],
            'CO': [0.0],
        ...
        'total': {
            'CH4': [7.858477],
            'CO': [150.34714400000001],
            'CO2': [1921.4582840000003],
            'NH3': [1.8160359999999998],
            'NOx': [1.4198380000000002],
            'PM10': [24.890511000000004],
            'PM2.5': [22.107725000000002],
            'SO2': [1.963135]
        }
    }
