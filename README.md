...
Then, to install, for example, v3.3.4, use the following (with sudo if necessary):

    pip install --no-binary gdal --extra-index https://pypi.airfire.org/simple bluesky==3.3.4
