...
Then, to install, for example, v0.3.3, use the following (with sudo if necessary):

    pip install --no-binary gdal --trusted-host pypi.smoke.airfire.org -i http://pypi.smoke.airfire.org/simple bluesky==0.3.3
...
Ingestion requires that none of the fires in 'fire_information' are empty objects.
 ...
 - ***'fire_information' > 'growth' > 'met_info'*** -- *optional* -- met_info is a field that is generated by the findmetdata module; ingestion passes it on if it's defined
 - ***'fire_information' > 'growth' > 'localmet'*** -- *optional* -- as with met_info, this field is generated by an internal module (localmet); ingestion passes this on if defined
 - ***'fire_information' > 'growth' > 'timeprofile'*** -- *optional* -- as with met_info, this field is generated by an internal module (timeprofiling); ingestion passes this on if defined
 - ***'fire_information' > 'growth' > 'plumerise'*** -- *optional* --  as with met_info, this field is generated by an internal module (plumerising); ingestion passes this on if defined
