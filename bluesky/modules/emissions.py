            ...
            if 'woody fuels' in fb["consumption"]:
                if 'piles' in fb["consumption"]['woody fuels']:
                    ...
                    if fb['consumption']['woody fuels']['piles']['flaming'][0] > 0 or \
                        ...
                        # EF are (pollutant lbs / ton consumed) (example: pm2.5 is 13.5lbs/ton), so we need to divide by 2000.0 to get tons/tons
                        # (pollutant lbs / ton of consumption)*(1 ton / 2000lbs) = tons of pollutant / ton of consumption
